...
public interface AbsenceLedgerRepository extends
    JpaRepository<AbsenceLedger, Long> {
  ...
  Optional<AbsenceLedger> findFirstByAbsenceRequestIdAndYearAndAmountLessThanOrderByCreatedAtAsc(
      Long absenceRequestId, int year, int amount);

  Optional<AbsenceLedger> findFirstByAbsenceRequestIdAndYearAndAmountGreaterThanOrderByCreatedAtAsc(
      Long absenceRequestId, int year, int amount);
